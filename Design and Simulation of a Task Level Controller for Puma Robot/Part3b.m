%% Part 3 with Initial Position Y(0) = [-0.5 ; -0.1 ; 0.0]
clear all; %#ok<CLALL>
clc;
%% Initialization
%First we initialize the required Initial and Final time as well as time step
tinitial = 0;
tstep = 0.01;
tfinal = 40;
